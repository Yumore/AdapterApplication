...
public class ReceiverAutoRestart extends BroadcastReceiver {
    ...
    public static void upgrade(boolean initialized, Context context) {
        synchronized (context.getApplicationContext()) {
            ...
            int newVersion = GuardUtils.getSelfVersionCode(context);
            ...
            if (!GuardUtils.canFilter(context)) {
            ...
            if (!GuardUtils.isDebuggable(context)) {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        if (Intent.ACTION_BOOT_COMPLETED.equals(action) || Intent.ACTION_MY_PACKAGE_REPLACED.equals(action)) {
            try {
                ...
                if (GuardUtils.isInteractive(context)) {
