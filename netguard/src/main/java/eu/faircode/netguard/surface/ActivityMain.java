...
import eu.faircode.netguard.adapter.AdapterRule;
import eu.faircode.netguard.entity.Rule;
import eu.faircode.netguard.receiver.ReceiverAutoRestart;
import eu.faircode.netguard.receiver.WidgetLockdown;
...
public class ActivityMain extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (adapter != null) {
                if (intent.hasExtra(EXTRA_CONNECTED) && intent.hasExtra(EXTRA_METERED)) {
                    ivIcon.setImageResource(GuardUtils.isNetworkActive(ActivityMain.this)
                    ...
                    if (intent.getBooleanExtra(EXTRA_CONNECTED, false)) {
                        ...
                        ivMetered.setVisibility(GuardUtils.isMeteredNetwork(ActivityMain.this) ? View.VISIBLE : View.INVISIBLE);
                    } else {
    ...
    private static Intent getIntentPro(Context context) {
        if (GuardUtils.isPlayStoreInstall(context))
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GuardUtils.logExtras(getIntent());
        ...
        // Upgrade
        ReceiverAutoRestart.upgrade(initialized, this);
        ...
        swEnabled.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    if (filter && GuardUtils.isPrivateDns(ActivityMain.this))
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (Build.VERSION.SDK_INT < MIN_SDK || GuardUtils.hasXposed(this))
            return;
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
        ...
        if (requestCode == REQUEST_VPN) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                GuardUtils.sendLogcat(target, this);
            }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (!GuardUtils.hasValidFingerprint(this) || getIntentInvite(this).resolveActivity(pm) == null)
    ...
    private void checkDoze() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (GuardUtils.batteryOptimizing(this) && getPackageManager().resolveActivity(doze, 0) != null) {
                final SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
    ...
    private void checkDataSaving() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            if (GuardUtils.dataSaving(this) && getPackageManager().resolveActivity(settings, 0) != null)
                try {
                    final SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
    ...
    private void menu_about() {
        ...
        // Show version
        tvVersionName.setText(GuardUtils.getSelfVersionName(this));
        if (!GuardUtils.hasValidFingerprint(this))
            tvVersionName.setTextColor(Color.GRAY);
        tvVersionCode.setText(Integer.toString(GuardUtils.getSelfVersionCode(this)));
    ...
    private Intent getIntentLogcat() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            if (GuardUtils.isPackageInstalled("org.openintents.filemanager", this)) {
