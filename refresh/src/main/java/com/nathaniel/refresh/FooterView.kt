...
import com.nathaniel.refresh.RefreshLayout.OnFooterStateListener
 ...
 * @author nathaniel
 */
class FooterView @SuppressLint("UseCompatLoadingForDrawables") constructor(context: Context) : RelativeLayout(context), OnFooterStateListener {
