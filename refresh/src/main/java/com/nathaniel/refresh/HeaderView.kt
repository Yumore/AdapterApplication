...
import com.nathaniel.refresh.RefreshLayout.OnHeaderStateListener
 ...
 * @author nathaniel
 */
class HeaderView @SuppressLint("UseCompatLoadingForDrawables") constructor(context: Context) : RelativeLayout(context), OnHeaderStateListener {
