 ...
 */
public class Demo3BindingFragment extends AbstractFragment<FragmentBindingDemo2Binding> {
    private static final String TAG = Demo3BindingFragment.class.getSimpleName();
    private final List<String> stringList = new ArrayList<>();
    private SimpleBindingAdapter simpleBindingAdapter;
    ...
    public void loadData() {
        ...
        simpleBindingAdapter = new SimpleBindingAdapter(stringList);
    }

    @Override
    public void bindView() {
        binding.demoTextTv.setText("这是代码设置的值fragment-demo3");
        ...
        binding.recyclerView.setAdapter(simpleBindingAdapter);
        simpleBindingAdapter.setOnItemClickListener((adapter, view, position) -> {
