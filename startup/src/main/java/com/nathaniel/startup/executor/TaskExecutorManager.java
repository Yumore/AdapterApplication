package com.nathaniel.startup.executor;
...
public class TaskExecutorManager {
    ...
    private TaskExecutorManager() {
        ...
        CPUThreadPoolExecutor = new ThreadPoolExecutor(CORE_POOL_SIZE, MAXIMUM_POOL_SIZE, KEEP_ALIVE_SECONDS, TimeUnit.SECONDS, poolWorkQueue, Executors.defaultThreadFactory(), executionHandler);
