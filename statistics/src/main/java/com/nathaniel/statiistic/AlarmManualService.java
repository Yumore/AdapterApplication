...
public class AlarmManualService extends Service {
    private static final String TAG = AlarmManualService.class.getSimpleName();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.d(TAG, TAG + "已开启");
        //触发广播，广播回调此方法，实现循环
        Intent intent1 = new Intent(this, AlarmManualReceiver.class);
